...
previous_command_succeeded
echo "Backup /mnt/lfs directory altogether (including source files and current build state) for the future use. Remember the \"Version-8.2-systemd\"."
echo "This makes a file \"/home/lfs/mnt_lfs_Version-8.2-systemd.tar.gz\"."
yes_or_no
pushd /home/lfs
  tar -zcf mnt_lfs_Version-8.2-systemd.tar.gz /mnt/lfs
popd
previous_command_succeeded
